...
<body>
    ...
    <div class="row">
        <div class="col-3 col-s-12 menu">
            <h2>Opciones</h2>
            <ul>
                <a href="04-paginaprofe.php?idprofe=<?php echo ($idprofe);?>" style="color: white;text-decoration: none;"><li>Principal</li></a>
                <a href= "05-paginaelaboracion.php?idprofe=<?php echo ($idprofe);?>&&idexamen=<?php echo ($idexamen);?>" style="color: white;text-decoration: none;"><li>Volver</li></a>
