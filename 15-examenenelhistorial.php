    ...
    <div class="row">
        <div class="col-3 col-s-12 menu">
            ...
            <ul>
                ...
                echo "<a href='12-paginaalumno.php?idalumno=$idalumno' style='color: #e9ecef;text-decoration: none;'><li>Volver</li></a>"?>
            </ul>
        </div>
        ...
        <div class="contenido col-9">
            ...
            <table class="tablita">
                ...
                $qry1=mysqli_query($conn,"SELECT respuesta_del_alumno FROM tabla_preguntaexamenesalumnos WHERE id_examen=$idexamen AND id_alumno=$idalumno");
					...
					if($respuesta_del_alumno==129) {//Veo cuales son iguales a 129(no respondida)
                        echo "					<tr>";
                        echo "					<td>";
