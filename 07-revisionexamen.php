    ...
    <div class="row">
        <div class="col-3 col-s-12 menu">
            ...
            <?php 
				...
				echo "<a href='06-tablaexamenes.php?idprofe=$idprofe&&idexamen=$idexamen' style='color: white;text-decoration: none;'><li>Revisiones</li></a>";
                ?>    
            </ul>
        </div>
        ...
        <div class="contenido col-9">
            ...
            <table class="tablita">
                ...
                {   
                    echo "<tr>";
					echo "<td colspan='2'>";
                    echo "			 <h3>Pregunta $i:".$result['preg']."</h3>";
                    echo "		</td>";
					echo "		</tr>";
